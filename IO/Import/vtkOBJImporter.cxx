...
struct ImportedPolydataWithMaterial
{
    ...
    { // intialise some structures to store the file contents in
        ...
        materialName  = "";
        mtlProperties = new obj_material;
    ...
    typedef std::map<std::string,ImportedPolydataWithMaterial*> NamedMaterials;
    std::string    materialName;
    obj_material*  mtlProperties;
};
        ...
        vtkInformationVector *outputVector)
{
            ...
            else if (strcmp(cmd, "f") == 0)
            {
                ...
                if( 0 == mtlCount ) {
                    ...
                    { // new material encountered; bag and tag it, make a new named-poly-data-container
                        ImportedPolydataWithMaterial*  novaya = new ImportedPolydataWithMaterial;
    ...
    { /** based on how many named materials are present,
        ...
        cout << "vtkOBJPolydataProcessor.cxx, set # of output ports to " << known_materials.size() << endl;
